...
def _cf_pick_bin_dir() -> Path:
    # ط¯غŒط³ع© ظ¾ط§غŒط¯ط§ط± ظ†ط¯ط§ط±غŒظ…طŒ ظ¾ط³ ظ‡ظ…غŒط´ظ‡ /tmp â€” ظ‡ط± ط±غŒâ€Œط§ط³طھط§ط±طھ ط¯ظˆط¨ط§ط±ظ‡ ط¯ط§ظ†ظ„ظˆط¯ ظ…غŒâ€Œط´ظ‡ ظˆظ„غŒ ظ…ط´ع©ظ„غŒ ظ†غŒط³طھ
    d = Path("/tmp") / "x4g_bin"
...
def hour_key(dt=None):
    # ظ‡ظ…â€Œط±ط§ط³طھط§ ط¨ط§ relay_vless.pyطŒ ظ…ط³طھظ‚غŒظ…ط§ظ‹ main.hourly_traffic ط±ط§ ط¨ط§
    # ع©ظ„غŒط¯ "HH:00" (ط¨ط¯ظˆظ† طھط§ط±غŒط®) ظ¾ط± ظ…غŒâ€Œع©ظ†ط¯ طھط§ ط¨ط§ ط³ط§ط¹طھ ط¨ظˆظ…غŒ ظ‡ظ…â€Œط³ط§ط² ط¨ط§ط´ط¯.
    dt = dt or now_ir()
...
def is_ip_allowed(link, uuid: str, ip: str) -> bool:
    """طھظˆط³ط· relay_vless.py طµط¯ط§ ط²ط¯ظ‡ ظ…غŒâ€Œط´ظˆط¯: ط¨ط±ط±ط³غŒ ظ…ط­ط¯ظˆط¯غŒطھ ط¢غŒâ€Œظ¾غŒ ظ‡ظ…â€Œط²ظ…ط§ظ†."""
    if not link:
        return False
...
# ============================================================
#  ط±ط¯غŒط§ط¨غŒ ط§طھطµط§ظ„ط§طھ ظپط¹ط§ظ„ / ط³ط§غŒظ…طھ
# ============================================================

async def try_register_connection(uid: str, ip: str, transport: str = "vless-ws"):
    """ظ‚ط¨ظ„ ط§ط² ظ¾ط°غŒط±ط´ ط§طھطµط§ظ„طŒ ط¨ط§غŒط¯ طµط¯ط§ ط²ط¯ظ‡ ط´ظˆط¯.
...
async def change_password(request: Request, _=Depends(require_auth)):
    ...
    await save_state()
    log_activity("auth", "ط±ظ…ط² ط¹ط¨ظˆط± طھظˆط³ط· ع©ط§ط±ط¨ط± ط¹ظˆط¶ ط´ط¯", "warn")
...
# ============================================================
#  ظ…ط¯غŒط±غŒطھ ظ„غŒظ†ع©â€Œظ‡ط§ (ع©ط§ط±ط¨ط±ط§ظ†)
# ============================================================
...
async def create_link(request: Request, _=Depends(require_auth)):
    ...
    await save_state()
    log_activity("link", f"ظ„غŒظ†ع© آ«{link['label']}آ» ط³ط§ط®طھظ‡ ط´ط¯", "ok")
...
async def edit_link(uid: str, request: Request, _=Depends(require_auth)):
    ...
    await save_state()
    log_activity("link", f"ظ„غŒظ†ع© {uid[:8]}â€¦ ظˆغŒط±ط§غŒط´ ط´ط¯", "info")
...
async def delete_link(uid: str, _=Depends(require_auth)):
    ...
    await save_state()
    log_activity("link", f"ظ„غŒظ†ع© {uid[:8]}â€¦ ط­ط°ظپ ط´ط¯", "warn")

    return {"ok": True}


# ============================================================
#  ظ…ط¯غŒط±غŒطھ ع¯ط±ظˆظ‡â€Œظ‡ط§غŒ ط§ط´طھط±ط§ع© (ط³ط§ط¨)
# ============================================================
...
async def create_sub(request: Request, _=Depends(require_auth)):
    ...
    name = str(body.get("name", "ع¯ط±ظˆظ‡غŒ ط¬ط¯غŒط¯"))[:60] or "ع¯ط±ظˆظ‡غŒ ط¬ط¯غŒط¯"
    ...
    await save_state()
    log_activity("sub", f"ع¯ط±ظˆظ‡غŒ آ«{name}آ» ط³ط§ط®طھظ‡ ط´ط¯", "ok")
...
async def edit_sub(sub_id: str, request: Request, _=Depends(require_auth)):
    ...
    await save_state()
    log_activity("sub", f"ع¯ط±ظˆظ‡غŒ {sub_id} ظˆغŒط±ط§غŒط´ ط´ط¯", "info")
...
async def delete_sub(sub_id: str, _=Depends(require_auth)):
    ...
    await save_state()
    log_activity("sub", f"ع¯ط±ظˆظ‡غŒ {sub_id} ط­ط°ظپ ط´ط¯", "warn")
...
# ط³ط§ط²ع¯ط§ط±غŒ ط¨ط§ ظ†ط§ظ… ظ…ط³غŒط± ظ‚ط¯غŒظ…غŒ/ط¬ط§غŒع¯ط²غŒظ† ط¨ط±ط§غŒ ع¯ط±ظˆظ‡ ط§ط´طھط±ط§ع©
@app.get("/subg/{sub_id}")
...
# ظ†ط§ظ… ظ…ط³غŒط± ط¬ط§غŒع¯ط²غŒظ† ط¨ط±ط§غŒ طµظپط­ظ‡â€ŒغŒ ط¹ظ…ظˆظ…غŒطŒ ظ…ط«ظ„ط§ظ‹ ط¨ط±ط§غŒ طµظپâ€Œط¨ظ†ط¯غŒ ع©ظˆطھط§ظ‡â€Œطھط±
...
# ============================================================
#  ظ…ط§عکظˆظ„â€Œظ‡ط§غŒ ط§ط®طھغŒط§ط±غŒطŒ ط§ع¯ط± ط¨ط§ط±ع¯ط°ط§ط±غŒ ظ†ط´ط¯ظ†ط¯ ط¨غŒâ€Œط®ط·ط± ط§ط¯ط§ظ…ظ‡ ط¨ط¯ظ‡
#  (طھط§ظ†ظ„ VLESS/WS ظˆ XHTTP)
#  غŒط±ع©ط¯ط§ظ… ظ…ط³طھظ‚ظ„ import ظ…غŒâ€Œط´ظˆظ†ط¯ طھط§ ظ†ط¨ظˆط¯ غŒع©غŒ ط¯غŒع¯ط±غŒ ط±ط§ ظ…طھظˆظ‚ظپ ظ†ع©ظ†ط¯
# ============================================================
...
# ============================================================
#  ظ…ط¯غŒط±غŒطھ ط®ط·ط§ظ‡ط§غŒ ط¨غŒâ€Œط¨ط±ظ†ط§ظ…ظ‡â€Œط±غŒط²غŒ
# ============================================================
