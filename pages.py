# pages.py  -  ASHKANPC v9.5
# ط´ط§ظ…ظ„: LOGIN_HTML, DASHBOARD_HTML, get_public_page_html()

# ظ„ظˆع¯ظˆغŒ ASHKANPC (ط¨ظ‡â€Œطµظˆط±طھ base64 ط¯ط§ط®ظ„غŒطŒ ط¨ط¯ظˆظ† ظ†غŒط§ط² ط¨ظ‡ ظ‡ط§ط³طھ ط®ط§ط±ط¬غŒ)
...
<title>ظˆط±ظˆط¯ آ· ASHKANPC</title>
...
<div class="wrap">
  <div class="card">
    <div class="brand">
      <div class="brand-img"><img src="data:image/png;base64,__LOGO_B64__" alt="ASHKANPC"></div>
      <div><div class="brand-name">ASHKANPC</div><div class="brand-sub">v9.5</div></div>
    </div>
    ...
    <div class="footer">ظ¾ط´طھغŒط¨ط§ظ†غŒ <a href="https://t.me/achkanpc" target="_blank"><i class="ti ti-brand-telegram"></i>@achkanpc</a></div>
  </div>
</div>
<script>
...
/* ASHKANPC responsive mobile overrides */
@media(max-width:1050px){
  html,body{overflow-x:hidden;width:100%}
  .main{width:100%;max-width:100%;box-sizing:border-box}
  .topbar{align-items:stretch}
  .tb-right{width:100%}
  .tb-right>*{max-width:100%}
  .card,.panel,.box,.modal-v2,.srv-panel,.cfg-card,.conn-card,.sub-card{max-width:100%;min-width:0}
  .cfg-vless,.sub-url,.sub-sub-url,.sub-card-url-text,.emsg{overflow-wrap:anywhere;word-break:break-word}
}
@media(max-width:600px){
  body{font-size:13px}
  .main{padding:62px 10px 42px}
  .topbar{margin-bottom:15px;gap:8px}
  .tb-title{font-size:16px}
  .tb-sub{font-size:10px}
  .metrics{gap:9px}
  .metric{padding:13px 12px}
  .panel,.card,.srv-panel{border-radius:14px}
  .srv-hero{padding:16px}
  .srv-tiles{grid-template-columns:1fr!important;padding:13px;gap:8px}
  .cfg-row,.cfg-card{overflow:hidden}
  .cfg-actions{display:grid!important;grid-template-columns:1fr 1fr;gap:7px!important}
  .cfg-actions .btn{width:100%;min-width:0;padding:10px 7px;font-size:11px}
  .sub-sub-box,.sub-box,.copy-all-bar{width:100%;min-width:0}
  .copy-all-bar{padding:13px}
  .copy-all-btn{width:100%;justify-content:center}
  .modal-v2{width:calc(100vw - 20px)!important;max-height:88vh;overflow:auto}
  .qr-box{width:calc(100vw - 24px)!important;max-width:360px!important;padding:14px!important}
  .qr-img{max-width:100%;overflow:hidden}
  .qr-img img{width:min(260px,72vw)!important;height:auto!important;max-width:100%}
  .lock-card{width:calc(100vw - 24px)!important;max-width:400px}
}
@media(max-width:380px){
  .main{padding-left:8px;padding-right:8px}
  .cfg-actions{grid-template-columns:1fr!important}
...
<div class="mob-top">
  <div class="ml">
    <div class="mob-logo"><img src="data:image/png;base64,__LOGO_B64__" alt="ASHKANPC"></div>
    <span class="mob-title">ASHKANPC</span>
  </div>
  <div class="mob-right">
...
<aside class="sidebar" id="sb">
  ...
  <div class="logo">
    <div class="logo-img"><img src="data:image/png;base64,__LOGO_B64__" alt="ASHKANPC"></div>
    <div><div class="logo-name">ASHKANPC</div><div class="logo-sub">v9.5</div></div>
  </div>
  <div class="nav-wrap">
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    <span class="df-text">ASHKANPC v9.5 آ· Railway</span>
    <a class="df-link" href="https://t.me/achkanpc" target="_blank"><i class="ti ti-brand-telegram"></i> @achkanpc</a>
...
<section class="pg" id="pg-support">
  ...
  <div class="srv-panel">
    <div class="srv-hero">
      ...
      <div class="srv-hero-text">
        <div class="srv-hero-domain">ظ¾ط´طھغŒط¨ط§ظ†غŒ ASHKANPC</div>
        <div class="srv-hero-sub"><span class="dot dg pulse"></span> ط±ط§ظ‡â€Œظ‡ط§غŒ ط§ط±طھط¨ط§ط·غŒ ط¨ط§ طھغŒظ… ASHKANPC</div>
      </div>
    </div>
    <div class="srv-tiles">
      <a class="srv-tile" href="https://t.me/achkanpc" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-brand-youtube"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">غŒظˆطھغŒظˆط¨</div><div class="srv-tile-val">@achkanpc</div></div>
      </a>
      <a class="srv-tile" href="https://t.me/achkanpc" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-brand-telegram"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">ط¢غŒط¯غŒ طھظ„ع¯ط±ط§ظ…</div><div class="srv-tile-val">@achkanpc</div></div>
      </a>
      <a class="srv-tile" href="https://t.me/achkanpc" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-users-group"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">ع¯ط±ظˆظ‡ طھظ„ع¯ط±ط§ظ…</div><div class="srv-tile-val">@achkanpc</div></div>
      </a>
      <a class="srv-tile" href="https://t.me/achkanpc" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-speakerphone"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">ع©ط§ظ†ط§ظ„ طھظ„ع¯ط±ط§ظ…</div><div class="srv-tile-val">@achkanpc</div></div>
      </a>
  ...
  return `<div class="cfg-card ${cardCls}">
    <div class="cfg-row">
      ...
      <div class="cfg-actions">
        ...
        <button class="btn btn-sm btn-g btn-icon" onclick="copySafe('${esc(l.vless_link)}','ظ„غŒظ†ع© VLESS ع©ظ¾غŒ ط´ط¯')" title="ع©ظ¾غŒ ظ„غŒظ†ع©"><i class="ti ti-copy"></i></button>
...
function copySafe(text, okMsg='ع©ظ¾غŒ ط´ط¯ âœ“'){{
  const value=String(text ?? '');
  if(!value){{toast('ظ…ظ‚ط¯ط§ط±غŒ ط¨ط±ط§غŒ ع©ظ¾غŒ ظˆط¬ظˆط¯ ظ†ط¯ط§ط±ط¯','err');return}}
  if(navigator.clipboard && window.isSecureContext){{
    navigator.clipboard.writeText(value).then(()=>toast(okMsg,'ok')).catch(()=>fallbackCopy(value,okMsg));
  }}else fallbackCopy(value,okMsg);
}}
function fallbackCopy(value,okMsg){{
  const ta=document.createElement('textarea'); ta.value=value; ta.style.position='fixed'; ta.style.opacity='0';
  document.body.appendChild(ta); ta.focus(); ta.select();
  try{{document.execCommand('copy');toast(okMsg,'ok')}}catch(e){{toast('ع©ظ¾غŒ ظ†ط§ظ…ظˆظپظ‚ ط¨ظˆط¯','err')}}
  ta.remove();
}}

function cpText(id){copySafe(document.getElementById(id).textContent)}
...
/* ASHKANPC public page mobile responsive */
@media(max-width:700px){{
  html,body{{width:100%;overflow-x:hidden}}
  .wrap{{width:100%;max-width:none;padding:0 10px}}
  .top{{padding:12px 0!important;gap:8px}}
  .brand-name{{font-size:14px}}
  .sub-info,.cfg-card,.copy-all-bar,.stats-bar{{max-width:100%;min-width:0}}
  .sub-sub-box{{flex-wrap:wrap}}
  .sub-sub-url{{flex:1 1 100%;min-width:0;overflow-wrap:anywhere;word-break:break-word}}
  .cfg-vless{{overflow-wrap:anywhere;word-break:break-all}}
  .cfg-actions{{display:grid!important;grid-template-columns:1fr 1fr;gap:7px!important}}
  .cfg-actions .btn{{width:100%;min-width:0;padding:10px 7px;font-size:11px}}
  .copy-all-bar{{flex-direction:column;align-items:stretch}}
  .copy-all-btn{{justify-content:center;width:100%}}
  .qr-box{{width:calc(100vw - 24px)!important;max-width:360px!important;padding:14px!important}}
  .qr-img img{{width:min(260px,72vw)!important;height:auto!important}}
  .lock-card{{width:calc(100vw - 24px)!important;max-width:400px}}
}}
@media(max-width:380px){{
  .cfg-actions{{grid-template-columns:1fr!important}}
...
<div class="wrap">
  <div class="top">
    <div class="brand">
      <div class="brand-img"><img src="data:image/png;base64,{LOGO_B64}" alt="ASHKANPC"></div>
      <div><div class="brand-name">ASHKANPC</div><div class="brand-sub">v9.5</div></div>
    </div>
  ...
  <div class="footer">ظ¾ط´طھغŒط¨ط§ظ†غŒ: <a href="https://t.me/achkanpc" target="_blank">@achkanpc</a> آ· ASHKANPC v9.5</div>
</div>
<script>
...
function showQR(label,link){{
  ...
  if(!logo){{
    ...
    logo.innerHTML='<img src="data:image/png;base64,{LOGO_B64}" alt="ASHKANPC">';
    ...
    <div class="sub-info">
      ...
      <div class="sub-sub-box">
        ...
        <button class="btn btn-pur" style="padding:7px 12px;font-size:10.5px"
          onclick="copySafe(window._x4gSubUrl,'ظ„غŒظ†ع© ط³ط§ط¨ ع©ظ¾غŒ ط´ط¯ âœ“')">
            ...
            <div class="cfg-bottom">
              ...
              <div class="cfg-actions">
                <button class="btn btn-p"
                  onclick="copySafe(window._x4gLinks[${{i}}].vless,'ظ„غŒظ†ع© VLESS ع©ظ¾غŒ ط´ط¯ âœ“')">
...
function copyAllConfigs(){{
  ...
  copySafe(text,'ظ‡ظ…ظ‡â€ŒغŒ '+toFa(links.length)+' ع©ط§ظ†ظپغŒع¯ ع©ظ¾غŒ ط´ط¯ âœ“');
}}
